...
inline const wchar_t* settingHelp(int id){
    static const wchar_t* model[]={
        ...
        L"UI修正实验开关，效果尚未证实。想保护字幕，优先框选NR保护区域。",
    ...
    case 202:return L"补帧倍率：2X插1张，3X插2张，4X插3张，5X/6X为实验档且受运行时实际上限限制。目标帧率涨了，显卡不一定跟得上；拖影也可能来凑热闹。";
    case 203:return L"实时档约1080p内部做NR再回填；原生档按处理阶段的原尺寸做NR。原生更吃算力，不保证处处更好看。";
    ...
    case 300:return L"选择保存过的增强配方。选中后点载入才上菜。";
    case 301:return L"给预设起个名字，最多48字。起得好找，下次少翻半天。";
    case 310:return L"载入选中的预设并应用参数。当前播放源不会换掉。";
    case 311:return L"用内建默认参数新建预设，不是复制当前参数。先打个干净的底。";
    case 312:return L"把当前参数另存为预设。调出好配方，先记下来。";
