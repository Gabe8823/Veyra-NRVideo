...
> 后续更新：下文为dc44c48阶段历史快照。1.3.0已整合其后修复至14b6ee0，最新完成项、边界和发布证据以[1.3.0更新说明](RELEASE_NOTES_1.3.0.md)与[发布记录](RELEASE_1.3.0_EXECUTION.md)为准，包括真实采集杂音修复、HDR转SDR新映射和逐子帧呈现；不再沿用下文“尚未实现tap”等历史状态。
